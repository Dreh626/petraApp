...
<body>
    ...
    <main>
        ...
        <div id="dados" class="row dados" alt="Dados Estatisticos">
            <div class="col-sm-2 text-center"></div>
            <?php 
                // // Instancia nova classe DadosEstatistico
                $dadosEstatisticos = new DadosEstatistico();

                // debug($dadosEstatisticos);
                // var_dump($dados);
                // exit();
            ...
            <div class="col-sm-2 text-center">
                ...
                ?>
                <h1><?= $this->Number->format($dado->numero) ?></h1>
                <p><?= h($dado->descricao) ?></p>
            </div>
            <?php endforeach; ?>
            <div class="col-sm-2 text-center"></div>
        </div>
